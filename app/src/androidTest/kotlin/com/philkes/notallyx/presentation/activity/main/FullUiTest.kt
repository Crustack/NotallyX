...
class FullUiTest {
    ...
    fun fullUiTest() {
        ...
        noteBodyInput.perform(replaceText("Body"), closeSoftKeyboard())

        val noteTitleInput = onView(allOf(withId(R.id.EnterTitle), isDisplayed()))
        noteTitleInput.perform(replaceText("Test"), closeSoftKeyboard())
        ...
        firstListItemInput.perform(replaceText("A"), closeSoftKeyboard())
        onView(
                allOf(
        ...
        secondListItemInput.perform(replaceText("B"), closeSoftKeyboard())
        onView(
                allOf(
                    withId(R.id.EditText),
                    withText("B"),
        ...
        thirdListItemInput.perform(replaceText("C"), closeSoftKeyboard())
        onView(
                allOf(
                    withId(R.id.EditText),
                    withText("C"),
        ...
        fourthListItemInput.perform(replaceText("D"), closeSoftKeyboard())
        ...
        listTitleInput.perform(replaceText("List"), closeSoftKeyboard())
        ...
        val openDrawerButton2 =
            onView(allOf(withContentDescription("Open navigation drawer"), isDisplayed()))
        openDrawerButton2.perform(click())
        ...
        val openDrawerButton3 =
            onView(allOf(withContentDescription("Open navigation drawer"), isDisplayed()))
        openDrawerButton3.perform(click())
        ...
        val openDrawerButton4 =
            onView(allOf(withContentDescription("Open navigation drawer"), isDisplayed()))
        openDrawerButton4.perform(click())
        ...
        val openDrawerButton5 =
            onView(allOf(withContentDescription("Open navigation drawer"), isDisplayed()))
        openDrawerButton5.perform(click())
        ...
        val secureFlagRowAgain = onView(withId(R.id.SecureFlag))
        secureFlagRowAgain.perform(scrollTo(), click())
        ...
        val openDrawerButton6 =
            onView(allOf(withContentDescription("Open navigation drawer"), isDisplayed()))
        openDrawerButton6.perform(click())
